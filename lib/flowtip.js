...
var Flowtip = function (_Component) {
  ...
  function Flowtip() {
    ...
    return _possibleConstructorReturn(this, (Flowtip.__proto__ || Object.getPrototypeOf(Flowtip)).apply(this, arguments));
  }
  ...
  _createClass(Flowtip, [{
    ...
    value: function rootPivot(region, targetParameter) {
      ...
      var _props$content2 = this.props.content,
          width = _props$content2.width,
          height = _props$content2.height;
    ...
    value: function calculatePosition(region, parent, target) {
      ...
      var _props$content3 = this.props.content,
          width = _props$content3.width,
          height = _props$content3.height;
      var _props$tail = this.props.tail,
          tailWidth = _props$tail.width,
          tailHeight = _props$tail.height;
    ...
    value: function calculateTailPosition(region, target, position) {
      ...
      var _props$content4 = this.props.content,
          height = _props$content4.height,
          width = _props$content4.width;
    ...
    value: function render() {
      ...
      var contentPosition = this.calculatePosition(region, parent, target, this.props.clamp);
